...
public class Repository implements IRepository {
    ...
    public void logPrgStateExec(PrgState state) {
        try {
            ...
            System.out.println("Latch Table:");
            logFile.println("Latch Table:");
            MyILatchTable<Integer, Integer>lt=state.getLatchTable();
             for (int address : lt.getAllKeys()) {
                logFile.println("\t" + address + "-->" + lt.get(address));
                System.out.println(address + "-->" +lt.get(address));
            }
