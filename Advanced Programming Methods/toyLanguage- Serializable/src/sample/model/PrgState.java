...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String, Integer> symTable, MyIList<Integer> out, IStmt stmt, MyIFileTable<Integer, FileData> tab, MyIHeap<Integer, Integer> hp){
        this.exeStack=stack;
