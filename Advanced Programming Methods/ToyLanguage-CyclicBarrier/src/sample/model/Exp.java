...
public abstract class Exp {
    public abstract int eval(MyIDictionary<String, Integer> symbolTable, MyIHeap<Integer, Integer> hp) throws NotExistingException, DivideByZeroException, OperatorException, EmptyException;
